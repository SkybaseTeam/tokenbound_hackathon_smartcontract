...
trait IMarketplace<TContractState> {
    fn get_price(ref self: TContractState, token_address: ContractAddress, token_id: u256) -> u256;
...
trait IMarketplaceCamel<TContractState> {
    fn getPrice(ref self: TContractState, token_address: ContractAddress, token_id: u256) -> u256;
