...
trait ICollection<TContractState> {
    ...
    fn mint_nft(ref self: TContractState, registry_contract: ContractAddress, implementation_hash: felt252) -> u256;
...
trait ICollectionCamel<TContractState> {
    ...
    fn mintNft(ref self: TContractState, registry_contract: ContractAddress, implementation_hash: felt252) -> u256;
