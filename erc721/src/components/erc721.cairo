...
mod ERC721Component {
    ...
    use openzeppelin::introspection::dual_src5::{
        DualCaseSRC5,
        DualCaseSRC5Trait
    };
    ...
    impl ERC721<
        ...
        +Drop<TContractState>
    > of IERC721<ComponentState<TContractState>> {
    ...
    impl ERC721CamelOnly<
        ...
        +SRC5Component::HasComponent<TContractState>,
        +Drop<TContractState>
    > of IERC721CamelOnly<ComponentState<TContractState>> {
